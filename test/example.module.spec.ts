...
import { ExampleConfigurationSchema } from "../src/example/config/example.configuration";
import { ExampleModuleBuilder } from "../src/example/builder/example-module.builder";
import { ExampleService } from "../src/example/example/example.service";
